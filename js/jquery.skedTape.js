(function(factory) {
    ...
    SkedTape.prototype = {
        ...
        renderEvent: function(event) {
            ...
            if (event.name != "personal") {
                $event.attr('customer_name', event.userData.customer_name.toString().toLowerCase()
                    .replace(/\s+/g, '-')
                    .replace(/[^\w\-]+/g, '')
                    .replace(/\-\-+/g, '-')
                    .replace(/^-+/, '')
                    .replace(/-+$/, ''))
                $event.attr('service_name', event.name.toString().toLowerCase()
                    .replace(/\s+/g, '-')
                    .replace(/[^\w\-]+/g, '')
                    .replace(/\-\-+/g, '-')
                    .replace(/^-+/, '')
            ...
            $event
                ...
                .attr('title', event.userData.customer_name)
                .css({
                    width: this.computeEventWidth(event),
                    left: this.computeEventOffset(event)
                });
            ...
            var name
            if (event.userData.name == 'personal') {
                name = event.userData.appointment_type
            } else {
                name = event.userData.customer_name
            }
